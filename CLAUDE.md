...
- Windows: `build_windows.ps1` + `elAPI_Plugins_x64.spec`, installer via `installer.iss`
...
│
├── scripts/                          # setup_env.sh/.ps1, package_mac.sh
...
- **Git commits: do NOT add "Co-Authored-By" trailers or any Claude/AI
